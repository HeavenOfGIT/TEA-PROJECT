...
HOSTCC       = $(CCACHE) gcc
HOSTCXX      = $(CCACHE) g++
HOSTCFLAGS   := -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fdelete-null-pointer-checks -fomit-frame-pointer -std=gnu89
HOSTCXXFLAGS = -O2
...
KBUILD_CFLAGS	+= -O2 -fdelete-null-pointer-checks
